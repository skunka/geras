jQuery(function($){
  if (typeof($.datepicker) === 'object') {
    $.datepicker.regional['en'] = {"closeText":"Close","prevText":"Previous","nextText":"Next","currentText":"Today","monthNames":["January","February","March","April","May","June","July","August","September","October","November","December"],"monthNamesShort":["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"dayNames":["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],"dayNamesShort":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"dayNamesMin":["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],"changeYear":true,"changeMonth":true,"weekHeader":"Wk","firstDay":0,"isRTL":false,"showMonthAfterYear":false,"dateFormat":"dd.mm.yy"};
    $.datepicker.setDefaults($.datepicker.regional['en']);
  }
  if (typeof($.timepicker) === 'object') {
    $.timepicker.regional['en'] = {"ampm":true,"hourText":"Hour","minuteText":"Minute","secondText":"Seconds","dateFormat":"dd.mm.yy ","timeFormat":"hh:mm tt"};
